...
<div>
    ...
    <div class="container-fluid bg-light rounded p-5 m-3">
        <div class="row">
            <h2 class="p-5 text-center text-black">Why Choose Bob's Banjo Lessons?</h2>
        </div>
        <div class="row">
    ...
    <div class="container-fluid bg-light rounded p-5 m-3">
        <div class="row">
            <h2 class="p-5 text-center text-black">Lesson Options</h2>
        </div>
    ...
    <div class="container-fluid bg-light rounded p-5 m-3">
        <div class="row">
            <h2 class="p-5 text-center text-black">Schedule Your Lesson Today!</h2>
        </div>
        <div class="row">

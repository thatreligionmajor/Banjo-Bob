                                ...
                                <div class="card-body">
                                    <blockquote class="blockquote mb-0">
                                        <p>If you are wanting to get an immersive experience in learning Banjo, working with Bob Bailey is a great
                                            way to start!</p>
                                        <footer class="blockquote-footer text-black">Glenn D.</footer>
                                    </blockquote>
                                </div>
                            </div>
                    </div>
                        ...
                        <div class="card bg-light text-black h-100">
                            ...
                            <div class="card-body">
                                <blockquote class="blockquote mb-0">
                                    ...
                                    <footer class="blockquote-footer text-black">Richard R.</cite></footer>
                                </blockquote>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card bg-light text-black h-100 ">
                            ...
                            <div class="card-body px-5">
                                <blockquote class="blockquote mb-0">
                                    ...
                                    <footer class="blockquote-footer text-black">Theresa B.</footer>
                                </blockquote>
                            </div>
                        </div>
                    </div>
